...
import Reparto.EmisionDeListados;
...
import Reparto.Listados;
import Reparto.PedidosParaReparto;
import Reparto.RevisionDeListados;
...
public class ListadoDeCargaPorVehiculo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        try{
            carga=pro.ListarPedidosParaCargaEnVehiculo(seleccion, fecha2);
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/isologo_32.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButton4, javax.swing.GroupLayout.DEFAULT_SIZE, 704, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 188, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       Revisionar pr1=new Listados();
       int numeroRev2=0;
       int numeroListado2=0;
       
       ls=(Listados) pr1.GenerarNuevoListado(seleccion, fecha2,true,true);
       ...
       System.err.println("NUMERO DE REVISION QUE SE APLICA AL LISTADO "+ls.getNumeroRevision());
        ...
        while(ic.hasNext()){
            ...
            //ped=pedi;
            detall=pr.detallePedidosParaCorreccion(ped.getCodigoTangoDePedido(),fecha2);
                    ...
                    */
                    ...
                    if(unidadActual == unidadAnterior){
                        ...
                        if(senal==0){
                            ...
                            ls2=(Listados) pr1.GenerarNuevoListado(pedi.getVehiculoAnterior(), pedi.getFechaEnvio(),nuevoListado,true);
        ...
        pr1.GuardarNumeroListadoEnPedido(cargaDetallada1,seleccion,fecha2);
